...
public class CubeState : MonoBehaviour
{
    ...
    public List<GameObject> Greifer = new List<GameObject>();
    ...
    public void PutDown(List<GameObject> lCubes, Transform pivot)
    {
        foreach (GameObject lCube in lCubes)
        {
            if (lCube != lCubes[4])
            {
                lCube.transform.parent.transform.parent = pivot;
            }
        }
    }
