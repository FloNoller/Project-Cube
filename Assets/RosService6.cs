...
public class RosService6 : MonoBehaviour
{
    ROSConnection ros;

    public string serviceName = "pos_srv6";
    ...
    void Start()
    {
        ...
        ros.RegisterRosService<PositionService6Request, PositionService6Response>(serviceName);
    ...
    private void Update()
    {
        ...
        if (Vector3.Distance(cube.transform.position, destination) < delta && Time.time > awaitingResponseUntilTimestamp)
        {
            ...
            ros.SendServiceMessage<PositionService6Response>(serviceName, positionService6Request, Callback_Destination6);
    ...
    void Callback_Destination6(PositionService6Response response)
    {
        ...
        destination0.eulerAngles = new Vector3(0f, 0f, 0f);
